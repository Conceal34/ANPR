...
def visual(video_path):
    ...
    out = cv2.VideoWriter('C:/Users/Vinner/Desktop/out.mp4', fourcc, fps, (width, height))
        ...
        if ret:
            ...
            for row_indx in range(len(df_)):
                ...
                try:
                    ...
                    cv2.putText(frame,
                                str(license_plate[df_.iloc[row_indx]['car_id']]['license_number']),
                                (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 0), 5)
